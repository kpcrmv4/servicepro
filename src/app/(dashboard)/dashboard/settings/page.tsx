...
export default async function SettingsPage({
  ...
  const sections = [
    ...
    { key: "branding", label: "Brand & สีของร้าน", icon: Palette, href: "/dashboard/settings/branding" },
    ...
    { key: "domain", label: "Custom Domain", icon: Globe, href: "/dashboard/settings/domain" },
