  ...
  const sidebarContent = (
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-16 items-center gap-3 border-b border-border px-4">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary text-primary-foreground font-bold text-sm shrink-0 shadow-md shadow-primary/30">
          KP
        </div>
        {!collapsed && (
          <div className="overflow-hidden">
            <h1 className="text-sm font-bold text-sidebar-fg truncate">KPServicePro</h1>
      ...
      <div className="border-t border-border p-3 space-y-1">
        ...
        <div className="hidden lg:block">
          <button
            ...
            className="flex w-full items-center justify-center rounded-2xl px-3 py-2 text-sidebar-muted hover:bg-muted hover:text-sidebar-fg transition-colors"
          >
